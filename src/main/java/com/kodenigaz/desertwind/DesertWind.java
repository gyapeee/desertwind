...
public class DesertWind {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            Felulet.parancsertelmezo(jelenetszam,
                    parancs); // A kapott parancsot értelmezi az adott helyszínen és változatja, jelen esetben csak a jelenetszamot mint globalis változót, egy nap lesz set get, de most egyelőre jo igy is
        } while (jelenetszam != 1);
    }
}
